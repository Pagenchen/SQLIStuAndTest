        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://github.com/Pagenchen/SQLIStuAndTest" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i>本项目开源地址</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
